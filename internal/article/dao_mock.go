...
// Source: graphblog/internal/article (interfaces: DAO)
//
// Generated by this command:
//
//	mockgen -destination=dao_mock.go -package=article . DAO
//
...
func (m *MockDAO) Create(arg0 model.Article) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockDAO) GetAll() ([]*model.Article, error) {
	m.ctrl.T.Helper()
