...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateTodo func(childComplexity int, input model.NewArticle) int
	}
...
type MutationResolver interface {
	CreateTodo(ctx context.Context, input model.NewArticle) (*model.Article, error)
}
type QueryResolver interface {
	Todos(ctx context.Context) ([]*model.Article, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createTodo":
		...
		return e.complexity.Mutation.CreateTodo(childComplexity, args["input"].(model.NewArticle)), true
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateTodo(rctx, fc.Args["input"].(model.NewArticle))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
